...
- Yesterday: I was programming the Project "Deploy An Article CMS To Azure" of the "Cloud Developer using Microsoft Azure" nanodegree: <https://github.com/udacity/nd081-c1-provisioning-microsoft-azure-vms-project-starter> And I rented Azure services to do the project.
- Yesterday: I rented an AWS instance g4dn.xlarge with 1 NVIDIA T4 GPU and 16 Gb GPU memory ($0.63 per hour)
<https://us-west-1.console.aws.amazon.com/ec2/v2/home?region=us-west-1#InstanceTypeDetails:instanceType=g4dn.xlarge>. Because I need to train a big convolutional neural network for this object detection project: <https://youtu.be/MfV_ATv9mlk>
- Today: I watched some video lectures and do some exercises in the "Cloud Developer using Microsoft Azure" nanodegree.
- Today: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "1. Lesson Introduction" (23% VIEWED). 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the nanodegrees Machine Learning DevOps Engineer and Self-Driving Car Engineer.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day033.png](images/Day033.png)

# Day 34: Saturday, July 10, 2021.

- Yesterday: I watched some video lectures and do some exercises in the "Cloud Developer using Microsoft Azure" nanodegree.
- Yesterday: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "1. Lesson Introduction" (23% VIEWED). 
- Today: I attended the meeting "A presentation of docker" by @Danilo.Britto.Scholar in the study team #st_spanish 
- Today: I'm training the neural network of my object detection project in an AWS instance g4dn.xlarge: <https://youtu.be/MfV_ATv9mlk>
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the nanodegrees Machine Learning DevOps Engineer and Self-Driving Car Engineer.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day034.jpg](images/Day034.jpg)

# Day 35: Sunday, July 11, 2021.

- Yesterday: I attended the meeting "A presentation of docker" by @Danilo.Britto.Scholar in the study team #st_spanish 
...
![images/Day035.png](images/Day035.png)
...
- Yesterday: I've been programming the project "Build an ML Pipeline for Short-Term Rental Prices in NYC".
- Today: I'm programming the project "Build an ML Pipeline for Short-Term Rental Prices in NYC" <https://github.com/udacity/nd0821-c2-build-model-workflow-starter> of the Machine Learning DevOps Engineer nanodegree, which is deployed in the Cloud through the website Weights & Biases: <https://wandb.ai/site>
- Today: We, @susyjam and I, are organizing a webinar called "Deep Reinforcement Learning (en Español)" in the Study Team #st_spanish. The tentative date is Saturday, July 17, 2021 (17:00 GMT-4). Here are the slides: http://bit.do/DeepRL3 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the nanodegrees Machine Learning DevOps Engineer and Self-Driving Car Engineer.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day037.png](images/Day037.png)

# Day 38: Wednesday, July 14, 2021.
...
# Day 39: Thursday, July 15, 2021. [Sprint #2]
...
# Day 40: Friday, July 16, 2021. [Sprint #2]

- Yesterday: I completed all the 4 certification opportunities of the Machine Learning DevOps Engineer Nanodegree and I graduated.
- Yesterday: We were organizing a webinar called "Deep Reinforcement Learning (en Español)" in the Study Team #st_spanish.
- Today: I'm still training the neural network of my object detection project in an AWS instance g4dn.xlarge: https://youtu.be/MfV_ATv9mlk
- Today: We, @susyjam and I, are organizing a webinar called "Deep Reinforcement Learning (en Español)" in the Study Team #st_spanish. The tentative date is Saturday, July 17, 2021 (17:00 GMT-4). Here are the slides: http://bit.do/DeepRL3 And here is the meeting link: https://meet.google.com/psv-ispj-mfk
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.
...
- Yesterday: I watched some video lectures and do some exercises of the Cloud Developer using Microsoft Azure Nanodegree.
- Today: I watched some video lectures and do some exercises of the Cloud Developer using Microsoft Azure Nanodegree.
- Today: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "5. Creating, Deploying and Invoking an Azure Function". (28% VIEWED). 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day044.png](images/Day044.png)

# Day 45: Wednesday, July 21, 2021. [Sprint #2]

- Yesterday: I watched some video lectures and do some exercises of the Cloud Developer using Microsoft Azure Nanodegree.
- Today: I'm doing the exercise in "3. Azure Microservices", "Lesson 2: Serverless Functions", "5. Creating, Deploying and Invoking an Azure Function". 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day045.png](images/Day045.png)

# Day 46: Thursday, July 22, 2021. [Sprint #2]

- Yesterday: I was doing the exercise in "3. Azure Microservices", "Lesson 2: Serverless Functions", "5. Creating, Deploying and Invoking an Azure Function". 
- Today: I filled the form of the Sprint 2 Completion and I got my bagde: :sprint2_badge:
- Today: I read the stories of the Student Stories Challenge and I voted for the top 3.
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day046.png](images/Day046.png)
![images/Day046-2.png](images/Day046-2.png)
...
![images/Day047.png](images/Day047.png)
...
- Today: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "7. Managing Cost". (33% VIEWED). 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day049.png](images/Day049.png)

# Day 50: Monday, July 26, 2021. [Sprint #2]

- Yesterday: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "8. Create Azure Cosmos DB Resources using Azure Portal". (34% VIEWED). 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.
...
- Yesterday: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: I got my badge for completing the course: :course_complete:
- Today: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "10. Create an Azure Function triggered by Cosmos DB - Part 1". (37% VIEWED). 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day052.png](images/Day052.png)
![images/Day052-2.png](images/Day052-2.png)


# Day 53: Thursday, July 29, 2021. [Sprint #2]

- Yesterday: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Yesterday: I got my badge for completing the course: :course_complete:
- Today: I attended the End of Program Party: [Recording](https://udacity.zoom.us/rec/play/TGQM6lB5FPcOgQ2D0Khfb03Mo5qDNXudvRhrUdV1saiYZOMhKLFFdT-UrwA4eA25TN-US57pOpDhncLq.ABMSJTyehVhrOA5r?continueMode=true&_x_zm_rtaid=n_2iIcanQbqxe-Us8skyaQ.1627587859161.1ef6cf2fc6e268cb8097dc19a24f16fb&_x_zm_rhtaid=238)
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day053.jpeg](images/Day053.jpeg)
![images/Day053-2.jpeg](images/Day053-2.jpeg)
...
- Yesterday: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: My current progress is "3. Azure Microservices", "Lesson 2: Serverless Functions", "14. Glossary". (44% VIEWED). 
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day055.png](images/Day055.png)
...
- Yesterday: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: I watched some video lectures and did some exercises of the **Cloud Developer using Microsoft Azure Nanodegree.**
- Today: My current progress is "3. Azure Microservices", "Lesson 3: Enterprise Logic Apps and Event Grid", "2. Logic Apps". (47% VIEWED). 
- Today: I got my certification to mentor the project "Motion Planning and Decision Making for Autonomous Vehicles" of the "Self-Driving Car Engineer Nanodegree".
- Blockers: I'm very busy with my work as a Udacity mentor, trying to finish many certifications opportunities of the Self-Driving Car Engineer Nanodegree.
- Encouraging: @Carlota.Pearl @Katherine @Manuel.T @Camila.Andrea.Gonzalez.Williamson @KaustubhaShravan @Manasvi.Trivedi @Prabor.Mukherjee @susyjam @AndyP @Jorge.Barrera @Ivan @MartinaF. @Jose.Vera @Juan.Carlos.Jimenez @Frida @Claudia.Everett @Patricio.Rojas @Danilo.Britto.Scholar @Oudarjya @nancy.alaswad @Prnika.Bakshi 
- **NOTE:** In July 7, I completed all the exercises and video lectures. So, in the remaining time, I will do some activities related to the Cloud and Kubernetes.

![images/Day056.png](images/Day056.png)
![images/Day056-2.png](images/Day056-2.png)
